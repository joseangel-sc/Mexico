...
STATES = [
    ...
    State('Edo Mex', 'Estado de México', 'Toluca de Lerdo', 'Ecatepec de Morelos', 22_357, 15_175_862),
    ...
    State('Michoacan', 'Michoacán de Ocampo', 'Morelia', 'Morelia', 1_34, 4_589_000),
